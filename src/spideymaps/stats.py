...
class Stats:
    ...
    def __add__(self, other):
        ...
        res.total_passed_map_creation = (
            self.total_passed_map_creation + other.total_passed_map_creation
        )
        res.total_failed_grid_creation = (
            self.total_failed_grid_creation + other.total_failed_grid_creation
        )
        res.total_failed_contour_creation = (
            self.total_failed_contour_creation + other.total_failed_contour_creation
        )
        res.total_tried_map_creation = (
            self.total_tried_map_creation + other.total_tried_map_creation
        )
